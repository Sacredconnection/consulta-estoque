...
import { PagnierReport } from "@/components/pagnier-report";
...
export default function Home(){
 ...
 const [activeView,setActiveView]=useState<"assistant"|"catalog"|"pagnier">("assistant"),[catalogProducts,setCatalogProducts]=useState<Product[]>([]);
