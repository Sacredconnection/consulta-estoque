...
export default function Home(){
 ...
 async function ask(text=message){
  if(!text.trim()||chatBusy)return;setExpandedQueries([]);setMessage("");setMessages(m=>[...m,{role:"user",text}]);setChatBusy(true);
