...
export type CatalogCursor={seenProductIds?:number[];sacredSources?:string;sacredPhase?:"retail";sacredCompleted?:number;sacredCursor?:CatalogCursor;catalogVersion:number;page:number;catalogDone:boolean;pending:{parent:WooProduct;page:number}[];productsSeen:number;productsDone:number;totalProducts:number;records:number;pagnier?:PagnierCursor;sourceRevision?:number};
